...
export default class LalibelaScene extends Phaser.Scene {
    constructor() {
        super("LalibelaScene");
    ...
    create() {
        const bg = this.add.image(0, 0, "lalibela_bg").setOrigin(0);
    ...
    async triggerDialogue() {
        ...
        await this.showDialogueAsync(uiScene, "እንኳን ደህና መጡ ወደ ላሊበላ።");
        await this.showDialogueAsync(uiScene, "ድንቅ ቤቶቹን እንዲያገኙ እንደሚያስችል ምልክት አስቀምጧል።");
        await this.showDialogueAsync(uiScene, "ምልክት ተሰጠዎታል።");

        uiScene.addClue("የላሊበላ ድንቅ ቤቶች ክፍል");

        this.time.delayedCall(3000, () => {
            this.cameras.main.fadeOut(1000, 0, 0, 0);
            this.cameras.main.once("camerafadeoutcomplete", () => {
                this.scene.start("OmoScene");
            });
        });
    }
